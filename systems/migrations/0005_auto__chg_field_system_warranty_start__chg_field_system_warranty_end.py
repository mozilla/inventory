...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'System.warranty_start'
        db.alter_column(u'systems', 'warranty_start', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'System.warranty_end'
        db.alter_column(u'systems', 'warranty_end', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'System.warranty_start'
        db.alter_column(u'systems', 'warranty_start', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'System.warranty_end'
        db.alter_column(u'systems', 'warranty_end', self.gf('django.db.models.fields.DateTimeField')(null=True))
