...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.current_metrics_oncall'
        db.add_column(u'user_profiles', 'current_metrics_oncall',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.current_metrics_oncall'
        db.delete_column(u'user_profiles', 'current_metrics_oncall')
