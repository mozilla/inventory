...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SystemRack.site'
        db.add_column(u'system_racks', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['site.Site'], null=True),
                      keep_default=False)


        # Changing field 'SystemRack.location'
        db.alter_column(u'system_racks', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systems.Location'], null=True))

    def backwards(self, orm):
        # Deleting field 'SystemRack.site'
        db.delete_column(u'system_racks', 'site_id')


        # Changing field 'SystemRack.location'
        db.alter_column(u'system_racks', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['systems.Location']))
