...
from systems.models import SystemType


class Migration(SchemaMigration):

    def forwards(self, orm):
        # Adding field 'System.system_type'
        db.add_column(u'systems', 'system_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['systems.SystemType'], null=True, blank=True),
                      keep_default=False)
        SystemType.objects.create(type_name='server')
        SystemType.objects.create(type_name='storage')
        SystemType.objects.create(type_name='networking')


    def backwards(self, orm):
        # Deleting field 'System.system_type'
        db.delete_column(u'systems', 'system_type_id')
