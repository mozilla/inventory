...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_netop_oncall'
        db.add_column(u'user_profiles', 'is_netop_oncall',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'UserProfile.current_netop_oncall'
        db.add_column(u'user_profiles', 'current_netop_oncall',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_netop_oncall'
        db.delete_column(u'user_profiles', 'is_netop_oncall')

        # Deleting field 'UserProfile.current_netop_oncall'
        db.delete_column(u'user_profiles', 'current_netop_oncall')
