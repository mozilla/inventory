...
urlpatterns = patterns('systems',
    ...
    url(r'^get_all_ranges_ajax[/]$', 'views.get_all_ranges_ajax', name='get-all-ranges-ajax'),
    url(r'^get_next_available_ip_by_range/(?P<range_id>\d+)[/]$', 'views.get_next_available_ip_by_range', name='system-adapter-next-ip'),
