...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        sql = """
        ALTER TABLE `static_interface` CHANGE `ip_upper` `ip_upper` BIGINT( 64 ) UNSIGNED;
        ALTER TABLE `static_interface` CHANGE `ip_lower` `ip_lower` BIGINT( 64 ) UNSIGNED;
        """
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1360609334'}),
