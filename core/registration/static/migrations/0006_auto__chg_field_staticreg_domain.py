...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StaticReg.domain'
        db.alter_column('static_reg', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domain.Domain'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'StaticReg.domain'
        raise RuntimeError("Cannot reverse this migration. 'StaticReg.domain' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'StaticReg.domain'
        db.alter_column('static_reg', 'domain_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['domain.Domain']))
    ...
    models = {
        ...
        'static.staticreg': {
            ...
            'domain': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['domain.Domain']", 'null': 'True'}),
