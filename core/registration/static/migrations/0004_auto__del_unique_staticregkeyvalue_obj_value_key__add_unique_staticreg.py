...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'StaticRegKeyValue', fields ['obj', 'value', 'key']
        db.delete_unique('static_key_value', ['obj_id', 'value', 'key'])

        # Adding unique constraint on 'StaticRegKeyValue', fields ['obj', 'key']
        db.create_unique('static_key_value', ['obj_id', 'key'])

        # Adding unique constraint on 'StaticReg', fields ['system', 'name']
        db.create_unique('static_reg', ['system_id', 'name'])


    def backwards(self, orm):
        # Removing unique constraint on 'StaticReg', fields ['system', 'name']
        db.delete_unique('static_reg', ['system_id', 'name'])

        # Removing unique constraint on 'StaticRegKeyValue', fields ['obj', 'key']
        db.delete_unique('static_key_value', ['obj_id', 'key'])

        # Adding unique constraint on 'StaticRegKeyValue', fields ['obj', 'value', 'key']
        db.create_unique('static_key_value', ['obj_id', 'value', 'key'])
