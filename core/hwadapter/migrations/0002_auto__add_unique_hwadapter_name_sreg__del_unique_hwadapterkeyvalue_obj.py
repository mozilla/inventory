...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'HWAdapterKeyValue', fields ['obj', 'value', 'key']
        db.delete_unique('hwadapter_key_value', ['obj_id', 'value', 'key'])

        # Adding unique constraint on 'HWAdapter', fields ['name', 'sreg']
        db.create_unique('hwadapter', ['name', 'sreg_id'])

        # Adding unique constraint on 'HWAdapterKeyValue', fields ['obj', 'key']
        db.create_unique('hwadapter_key_value', ['obj_id', 'key'])


    def backwards(self, orm):
        # Removing unique constraint on 'HWAdapterKeyValue', fields ['obj', 'key']
        db.delete_unique('hwadapter_key_value', ['obj_id', 'key'])

        # Removing unique constraint on 'HWAdapter', fields ['name', 'sreg']
        db.delete_unique('hwadapter', ['name', 'sreg_id'])

        # Adding unique constraint on 'HWAdapterKeyValue', fields ['obj', 'value', 'key']
        db.create_unique('hwadapter_key_value', ['obj_id', 'value', 'key'])
    ...
    models = {
        ...
        'hwadapter.hwadapter': {
            'Meta': {'unique_together': "(('mac', 'sreg'), ('sreg', 'name'))", 'object_name': 'HWAdapter', 'db_table': "'hwadapter'"},
        ...
        'hwadapter.hwadapterkeyvalue': {
            'Meta': {'unique_together': "(('key', 'obj'),)", 'object_name': 'HWAdapterKeyValue', 'db_table': "'hwadapter_key_value'"},
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2013101601'}),
