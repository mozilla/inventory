...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Range.dhcpd_raw_include'
        db.add_column('range', 'dhcpd_raw_include',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Range.dhcpd_raw_include'
        db.delete_column('range', 'dhcpd_raw_include')
