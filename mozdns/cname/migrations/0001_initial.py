...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cname', ['CNAME'])
        ...
        db.create_table('cname_views', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cname', models.ForeignKey(orm['cname.cname'], null=False)),
            ('view', models.ForeignKey(orm['view.view'], null=False))
        ))
        db.create_unique('cname_views', ['cname_id', 'view_id'])
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1360538199'}),
            'ttl': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3600', 'null': 'True', 'blank': 'True'})
        },
        'view.view': {
