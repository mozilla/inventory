...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('domain', (
            ...
            ('master_domain', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['domain.Domain'], null=True, blank=True)),
            ('soa', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['soa.SOA'], null=True, blank=True)),
    ...
    models = {
        ...
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1360538200'}),
