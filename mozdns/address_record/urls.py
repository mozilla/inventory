...
from mozdns.address_record.views import (AddressRecordListView,
                                        AddressRecordCreateView,
                                        AddressRecordUpdateView,
                                        AddressRecordDeleteView,
                                        AddressRecordDetailView)

urlpatterns = patterns('',
                       url(r'^$', csrf_exempt(
                           AddressRecordListView.as_view())),
                       url(r'(?P<domain>[\w-]+)/create/$',
                           csrf_exempt(AddressRecordCreateView.as_view())),
                       url(r'create/', csrf_exempt(
                           AddressRecordCreateView.as_view())),
                       url(r'(?P<pk>[\w-]+)/update/$',
