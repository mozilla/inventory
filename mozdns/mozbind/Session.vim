...
nmap ,p iimport pdb;pdb.set_trace()
nmap ,h :noh
map ,q :e ~/buffer
noremap ,m mmHmt:%s///ge'tzt'm
map ,s? z=
...
silent only
cd ~/inventory/inventory/mozdns/mozbind
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 management/commands/bindbuild.py
args management/commands/bindbuild.py
edit management/commands/bindbuild.py
