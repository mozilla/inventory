...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SOA.is_signed'
        db.add_column('soa', 'is_signed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SOA.is_signed'
        db.delete_column('soa', 'is_signed')
    ...
    models = {
        'soa.soa': {
            ...
            'serial': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1360681649'}),
