...
BZ=/home/juber/inventory/mdns/migrate/build_migration_configs/bz_legacy.sh
ZONE_CONFIGS=/home/juber/inventory/mdns/migrate/zone_configs
rm -rf $ZONE_CONFIGS
mkdir $ZONE_CONFIGS
touch $ZONE_CONFIGS/__init__.py

#$BZ cn /home/juber/sysadmins/dnsconfig/cn > $ZONE_CONFIGS/cn_zone_config.py
#python $ZONE_CONFIGS/cn_zone_config.py

#$BZ external /home/juber/sysadmins/dnsconfig/external > $ZONE_CONFIGS/external_zone_config.py
#python $ZONE_CONFIGS/external_zone_config.py

$BZ phx /home/juber/sysadmins/dnsconfig/phx > $ZONE_CONFIGS/phx_zone_config.py
...
./build_migration_configs/bz_legacy.sh external /home/juber/sysadmins/dnsconfig/external > $ZONE_CONFIGS/external.py
